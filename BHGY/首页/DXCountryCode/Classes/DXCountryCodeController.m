...
@interface DXCountryCodeController ()<UITableViewDataSource,UITableViewDelegate,UISearchResultsUpdating,DSectionIndexViewDelegate,DSectionIndexViewDataSource,UISearchControllerDelegate>
{
...
- (void)creatSubviews{
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, statusBarH + 44, self.view.bounds.size.width-tableViewOffset, self.view.bounds.size.height-statusBarH) style:UITableViewStylePlain];
    ...
    _searchController.searchBar.frame = CGRectMake(100,0 , 200, 40);
...
- (void)updateSearchResultsForSearchController:(UISearchController *)searchController {
    ...
    if (searchController.active) {
        _searchController.searchBar.frame = CGRectMake(40,0 , 200, 40);
