    ...
    switch (placementsStyle) {
        ...
        case 2:// 菜单在触发按钮底部显示
        {
            ...
            if ( centerX - self.menuWidth/2 <0) {// 触发按钮太靠左了。
                ...
                self.menuRect = CGRectMake(centerX  - self.menuWidth/2 - 20, CGRectGetMaxY(self.startFrame)+self.interval, self.menuWidth, self.menuHeight);
            }
            
            self.arrowStartPoint = CGPointMake(centerX - self.menuRect.origin.x - 5 , 0);
