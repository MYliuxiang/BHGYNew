...
{
    BANetManagerShare.sessionManager = [[AFHTTPSessionManager manager] initWithBaseURL:[NSURL URLWithString:@"https://cdn-appdemo.zfx.cn"]];
...
//产生随机字符串
+ (NSString *)generateTradeNO:(int)count
{
