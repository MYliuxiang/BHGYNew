...
//    [self layoutButtonWithEdgeInsetsStyle:MKButtonEdgeInsetsStyleLeft imageTitleSpace:5];
}
...
- (void)setTitle:(NSString *)title forState:(UIControlState)state{\
    ...
    [WMZDropMenuTool TagSetImagePosition:self.position spacing:5 button:self];
}
@end
