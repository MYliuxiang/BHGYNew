...
- (void)updateUI{
    ...
    for (int i = 0; i<self.titleArr.count; i++) {
        ...
        [WMZDropMenuTool TagSetImagePosition:btn.position spacing:5 button:btn];
...
//    CGRect rect = [self convertRect:self.frame toView:MenuWindow];
//    rect.origin.y = rect.origin.y + rect.size.height;
//    rect.size.height = self.dataView.bounds.size.height;
//    self.dataView.frame = rect;
    
//    CGRect rect1 = [self convertRect:self.frame toView:MenuWindow];
//       rect1.origin.y = rect1.origin.y + rect1.size.height;
//       rect1.size.height = self.shadowView.bounds.size.height;
//       self.shadowView.frame = rect1;
